<template>
    <div class="app-container">
        ...
        <el-table border :data="friendList" @selection-change="handleSelectionChange" v-loading="loading">
            ...
            <!-- 番剧图标 -->
            <el-table-column prop="avatar" label="番剧图标" align="center" width="100">
                <template #default="scope">
                    <img :src="scope.row.avatar" width="40" height="40" />
                </template>
            </el-table-column>
            <!-- 番号颜色 -->
            <el-table-column prop="color" label="番号颜色" align="center" width="100">
                <template #default="scope">
                </template>
            </el-table-column>
            <!-- 番剧名称 -->
            <el-table-column prop="name" label="番剧名称" align="center" :show-overflow-tooltip="true"
                width="180"></el-table-column>
            <!-- 番剧地址 -->
            <el-table-column prop="url" label="番剧地址" align="center" width="220"></el-table-column>
            <!-- 番剧介绍 -->
            <el-table-column prop="introduction" label="番剧介绍" align="center"
        ...
        <el-dialog :title="title" v-model="addOrUpdate" width="450px" append-to-body>
            <el-form ref="friendFormRef" label-width="100px" :model="friendForm" :rules="rules" @submit.native.prevent>
                <el-form-item label="番剧名称" prop="name">
                    <el-input placeholder="请输入番剧名称" v-model="friendForm.name" style="width: 250px;" />
                </el-form-item>
                <el-form-item label="番号颜色" prop="color">
                    <el-color-picker v-model="friendForm.color"></el-color-picker>
                </el-form-item>
                <el-form-item label="番剧图标" prop="avatar">
                    <el-input placeholder="请输入番剧图标" v-model="friendForm.avatar" style="width: 250px;" />
                </el-form-item>
                <el-form-item label="番剧地址" prop="url">
                    <el-input placeholder="请输入番剧地址" v-model="friendForm.url" style="width: 250px;" />
                </el-form-item>
                <el-form-item label="番剧介绍" prop="introduction">
                    <el-input placeholder="请输入番剧介绍" v-model="friendForm.introduction" style="width: 250px;" />
                </el-form-item>
            </el-form>
            <template #footer>
...
const rules = reactive<FormRules>({
    ...
    color: [{ required: true }],
    avatar: [{ required: true, message: "请输入番剧图标", trigger: "blur" }],
    url: [{ required: true, message: "请输入番剧地址", trigger: "blur" }],
    introduction: [{ required: true, message: "请输入番剧介绍", trigger: "blur" }],
});
const data = reactive({
    count: 0,
    showSearch: true,
