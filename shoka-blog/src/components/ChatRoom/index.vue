  ...
  <div v-if="blog.blogInfo.siteConfig.isChat">
    <div class="chat-container" v-show="show">
      <div class="chat-header">
        <img width="32" height="32" src="https://hmleadnewsyouzi.oss-cn-beijing.aliyuncs.com/images/%E8%81%8A%E5%A4%A9%E5%AE%A4%E5%B0%81%E9%9D%A2.jpg" />
    ...
    <img src="./ims.gif"  class="circle-image" />
    </div>
  </div>
</template>
